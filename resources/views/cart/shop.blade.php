                    ...
                    <div class="col mb-5">
                        <div class="card h-100">
                            ...
                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                <div class="text-center"><a class="btn btn-outline-dark mt-auto" href="{{route('add-to-cart', $product->id)}}"><i class="fa fa-cart-plus" aria-hidden="true"></i>&nbsp;</a></div>
                                <div class="text-center"><a class="btn btn-outline-danger mt-auto" href="{{route('add-to-wishlist', $product->id)}}"><i class="fa fa-heart" aria-hidden="true"></i></i>&nbsp;</a></div>
                            </div>
                        </div>
                    </div>
                    @endforeach
