                ...
                <table class="table table-striped table-light table-responsive">
                    <thead class="thead-inverse">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td scope="row">{{++$post->index}}</td>
                                <td><img src="{{asset($post->image)}}" class="img-fluid ${3|rounded-top,rounded-right,rounded-bottom,rounded-left,rounded-circle,|}" height="80" width="100" alt="Image"></td>
                                <td>{{$post->title}}</td>
